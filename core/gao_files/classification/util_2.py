"""
Util file from:
https://github.com/gao-g/metaphor-in-context/tree/master/classification
"""
...
def get_embedding_matrix(word2idx, idx2word, normalization=False):
    ...
    embedding_dim = 300
    glove_path = os.path.join("drive", "MyDrive", "metaphor_detection", "resources", "glove", "glove840B300d.txt")
    glove_vectors = {}
...
def embed_sequence(sequence, verb_idx, word2idx, glove_embeddings, elmo_embeddings, suffix_embeddings):
    ...
    indicated_sequence[int(verb_idx)] = 1
